...
repo's locator to turn anchors into offsets, IoU@0.5 greedy one-to-one scoring.
    ...
    python scripts/tsawa/gemini/run_tsawa_zeroshot.py --books P000084 I895C519A \
...
sys.path.insert(0, str(ROOT / "src" / "tsawa" / "zeroshot"))
...
SPANS = ROOT / "data/processed/tsawa/tsawa_spans_merged.csv"
