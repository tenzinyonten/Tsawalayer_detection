...
-----
    ...
    python analyze_errors.py --model ./runs/sqrt_inv_best --dataset ./data/processed/tsawa/tsawa_dataset
"""
...
def main():
    ...
    ap.add_argument("--out", default="scratch/tsawa/analysis/error_analysis")
