...
Writes data/processed/sabche_split_v1_frozen.csv,
data/processed/sabche_excluded_books.csv, scratch/sabche_split_<version>_report.json.
"""
...
AUDIT = ROOT / "data/processed/tsawa_audit.csv"
CLEAN = ROOT / "data/processed/sabche_spans_clean.csv"
VERDICTS = ROOT / "data/processed/sabche_book_verdicts.csv"
SPLIT_V3 = ROOT / "data/processed/split_v3_frozen.csv"
OUT_EXCL = ROOT / "data/processed/sabche_excluded_books.csv"
...
def main(argv=None) -> int:
    ...
    OUT_SPLIT = ROOT / f"data/processed/sabche_split_{args.version}_frozen.csv"
    OUT_REPORT = ROOT / f"scratch/sabche_split_{args.version}_report.json"
    ...
    with OUT_SPLIT.open("w", newline="", encoding="utf-8") as fh:
        fh.write(
            ...
            "# generator: src/prepare_sabche_split.py\n"
            f"# seed: {SEED}\n"
