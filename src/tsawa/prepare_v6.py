...
MERGED = ROOT / "data/processed/tsawa/tsawa_spans_merged.csv"
AUDIT = ROOT / "data/processed/tsawa/tsawa_audit.csv"
SPLIT_V2 = ROOT / "data/processed/tsawa/split_v2_frozen.csv"
QUOTE_SC = ROOT / "data/processed/tsawa/quotation_spans_snapped.csv"
OUT_SPLIT = ROOT / "data/processed/tsawa/split_v3_frozen.csv"
OUT_IGNORE = ROOT / "data/processed/tsawa/v6_ignore_spans.csv"
OUT_GROUPS = ROOT / "scratch/tsawa/analysis/v6_root_groups.json"
OUT_REPORT = ROOT / "scratch/tsawa/analysis/v6_prep_report.json"
V5 = ROOT / "data/processed/tsawa/tsawa_dataset_v5_merged"
...
def main() -> int:
    ...
    header = [
        ...
        "# generator: src/tsawa/prepare_v6.py (greedy multi-objective, same as split_v2)",
        f"# seed: {SEED}",
        ...
        "# span source: data/processed/tsawa/tsawa_spans_merged.csv",
    ]
