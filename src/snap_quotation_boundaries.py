...
Usage:
    python src/snap_quotation_boundaries.py \\
        --audit-csv data/processed/tsawa_audit.csv \\
        --raw-opf-dir data/raw_opf \\
        --out data/processed/quotation_spans_snapped.csv
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--audit-csv", type=Path, default=Path("data/processed/tsawa_audit.csv"))
    p.add_argument("--raw-opf-dir", type=Path, default=Path("data/raw_opf"))
    p.add_argument(
        "--out",
        type=Path,
        default=Path("data/processed/quotation_spans_snapped.csv"),
