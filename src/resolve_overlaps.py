...
Usage:
    python src/resolve_overlaps.py \\
        --sidecar data/processed/tsawa_spans_snapped.csv \\
        --raw-opf-dir data/raw_opf \\
        --out data/processed/tsawa_spans_resolved.csv \\
        --log data/processed/overlap_resolve_log.csv
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument(
        "--log",
        type=Path,
        default=Path("data/processed/overlap_resolve_log.csv"),
    )
    p.add_argument(
        "--expect",
        type=int,
