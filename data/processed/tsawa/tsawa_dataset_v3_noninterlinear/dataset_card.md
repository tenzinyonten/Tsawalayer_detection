...
- **Built:** 2026-09-18 by `src/tsawa/build_tsawa_dataset.py`
- **Span source:** `data/processed/tsawa/tsawa_spans_resolved.csv`
- **Split file:** `data/processed/tsawa/split_v2_frozen.csv` (frozen v2 split, seed 123)
...
- `data/processed/tsawa/tsawa_dataset/` — v1, coverage-quartile split (seed 42)
- `data/processed/tsawa/tsawa_dataset_v2/` — frozen split, all 212 documents
