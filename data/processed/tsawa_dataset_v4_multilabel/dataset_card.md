...
- **Built:** 2026-09-18 by `src/build_tsawa_dataset.py --quote-sidecar`
- **Tsawa spans:** `data/processed/tsawa_spans_resolved.csv` (21,149 active)
- **Quotation spans:** `data/processed/quotation_spans_snapped.csv` (29,538 active)
- **Split file:** `data/processed/split_v2_frozen.csv` — document assignment unchanged from v2
...
- `data/processed/tsawa_dataset_v2/` — 3-label, all 212 documents, same split
- `data/processed/tsawa_dataset_v3_noninterlinear/` — 3-label, 5 interlinear books out of train
