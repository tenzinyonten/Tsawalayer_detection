...
- **Generator:** `scratch/build_stratified_split.py`, greedy multi-objective, **seed 123**
...
- **Assignment file:** `data/processed/split_v2_frozen.csv`
...
recorded in `data/processed/tsawa_dataset_v2/dataset_card.md` after the rebuild.
