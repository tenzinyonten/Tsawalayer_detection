...
Usage:
    python sabche/src/clean_sabche_spans.py
"""
...
OUT = ROOT / "sabche/data/processed/sabche_spans_clean.csv"
OUT_BOOKS = ROOT / "sabche/data/processed/sabche_book_verdicts.csv"
