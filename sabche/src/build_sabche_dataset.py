...
Usage:
    python sabche/src/build_sabche_dataset.py
"""
...
def parse_args(argv=None):
    ...
    p.add_argument("--sidecar", type=Path, default=ROOT / "sabche/data/processed/sabche_spans_clean.csv")
    p.add_argument("--split-file", type=Path, default=ROOT / "sabche/data/processed/sabche_split_v1_frozen.csv")
    p.add_argument("--tokenizer", default="jhu-clsp/mmBERT-base")
    p.add_argument("--max-length", type=int, default=8192)
    p.add_argument("--stride", type=int, default=5120)
    p.add_argument("--out-dir", type=Path, default=ROOT / "sabche/data/processed/sabche_dataset_v1")
    p.add_argument("--stats-json", type=Path, default=ROOT / "sabche/data/processed/sabche_dataset_v1_stats.json")
