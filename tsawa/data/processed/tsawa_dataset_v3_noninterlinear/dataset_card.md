...
- **Built:** 2026-09-18 by `common/build_tsawa_dataset.py`
- **Span source:** `tsawa/data/processed/tsawa_spans_resolved.csv`
- **Split file:** `tsawa/data/processed/split_v2_frozen.csv` (frozen v2 split, seed 123)
...
- `tsawa/data/processed/tsawa_dataset/` — v1, coverage-quartile split (seed 42)
- `tsawa/data/processed/tsawa_dataset_v2/` — frozen split, all 212 documents
