...
- **Built:** 2026-09-18 by `common/build_tsawa_dataset.py --quote-sidecar`
- **Tsawa spans:** `tsawa/data/processed/tsawa_spans_resolved.csv` (21,149 active)
- **Quotation spans:** `tsawa/data/processed/quotation_spans_snapped.csv` (29,538 active)
- **Split file:** `tsawa/data/processed/split_v2_frozen.csv` — document assignment unchanged from v2
...
- `tsawa/data/processed/tsawa_dataset_v2/` — 3-label, all 212 documents, same split
- `tsawa/data/processed/tsawa_dataset_v3_noninterlinear/` — 3-label, 5 interlinear books out of train
